...
local ACCENT = {0.11, 0.58, 0.86} -- bluish accent
...
local function CreateButton(parent, width, height, text)
    ...
    b.text:SetFont(FONT, BODY_FONT_SIZE, "OUTLINE")
...
local function CreateEditBox(parent, width, height, initial)
    ...
    eb:SetBackdropBorderColor(0.04, 0.05, 0.06)
...
frame.title:SetFont(FONT, TITLE_FONT_SIZE, "OUTLINE")
frame.title:SetText("NuggetList v0.2")

frame.author = frame:CreateFontString(nil, "OVERLAY")
frame.author:SetPoint("TOP", frame.title, "BOTTOM", 0, -2)
frame.author:SetFont(FONT, BODY_FONT_SIZE - 1)
frame.author:SetTextColor(0.84, 0.65, 0.04)
frame.author:SetText("by Dopalone")
...
cbX:SetFont(FONT, 12, "OUTLINE")
cbX:SetPoint("CENTER")
cbX:SetText("×")
cbX:SetTextColor(1, 0.6, 0.6)
closeButton:SetScript("OnClick", function() frame:Hide() end)

local searchBox = CreateEditBox(frame, 60, 24, "Search...")
